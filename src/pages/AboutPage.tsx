        ...
        <Card>
          ...
          <CardContent>
            ...
            <div className="mt-4 space-y-2">
              <p className="text-gray-700"><strong>Email:</strong> support@companira.com</p>
              <p className="text-gray-700"><strong>Support Hours:</strong> Monday-Friday, 9am-5pm CET</p>
            </div>
          </CardContent>
        </Card>
      </div>
